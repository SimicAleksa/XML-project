...
import { API_CR_JSON, API_CR_RDF, API_CR_REPORT, API_FETCH_PENDING_TM_REQS_URL, API_GEN_TM_PDF, API_GEN_TM_XHTML, API_LOGIN_URL, API_PAT_JSON, API_PAT_RDF, API_PAT_REFERANCED_SEARCH, API_SEND_TM_RESENJE, API_TM_ADVANCED_SEARCH, API_TM_BASIC_SEARCH, API_TM_JSON, API_TM_RDF, API_TM_REPORT, API_USER_INFO_URL } from "../configs/api-urls";

...
import { API_CR_ADVANCED_SEARCH, API_CR_BASIC_SEARCH, API_FETCH_PENDING_CR_REQS_URL, API_FETCH_PENDING_PAT_REQS_URL, API_GEN_CR_PDF, API_GEN_CR_XHTML, API_GEN_PAT_PDF, API_GEN_PAT_XHTML, API_LOGIN_URL, API_PAT_ADVANCED_SEARCH, API_PAT_BASIC_SEARCH, API_PAT_REPORT, API_REGISTRATION_URL, API_SEND_CR_REQ_URL, API_SEND_CR_RESENJE, API_SEND_PATENT_REQ_URL, API_SEND_PAT_RESENJE, API_SEND_TRADEMARK_REQ_URL } from "../configs/api-urls";

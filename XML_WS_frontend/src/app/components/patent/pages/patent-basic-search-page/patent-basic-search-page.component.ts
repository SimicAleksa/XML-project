...
@Component({
  selector: 'app-patent-basic-search-page',
  templateUrl: './patent-basic-search-page.component.html',
  styleUrls: ['./patent-basic-search-page.component.css']
})
export class PatentBasicSearchPageComponent implements OnInit {
    ...
    performBasicSearch() {
      ...
      this.requestMaker
      .doPATBasicSearch(this.getParamsDTO(params))
      .subscribe({
        next: (data: any) => {
    ...
    handleSelectedRow(patNum: string) {
      this.selectedPAT = patNum;
    }

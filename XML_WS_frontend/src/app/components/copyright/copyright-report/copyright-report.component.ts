...
@Component({
  selector: 'app-copyright-report',
  templateUrl: './copyright-report.component.html',
  styleUrls: ['./copyright-report.component.css']
})
export class CopyrightReportComponent implements OnInit {
    ...
    generateReport() {
      ...
      this.requestMaker
      .createCRreport(this.getParamsDTO())
      .subscribe({
        next: (data: any) => {

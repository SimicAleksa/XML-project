...
@Component({
  selector: 'app-cr-advanced-search',
  templateUrl: './cr-advanced-search.component.html',
  styleUrls: ['./cr-advanced-search.component.css']
})
export class CrAdvancedSearchComponent implements OnInit {
  ...
  handleSelectedRow(copyrightNum: string) {
    this.selectedCR = copyrightNum;
  }

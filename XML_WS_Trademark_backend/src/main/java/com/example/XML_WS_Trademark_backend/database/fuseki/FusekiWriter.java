package com.example.XML_WS_Trademark_backend.database.fuseki;

import com.example.XML_WS_Trademark_backend.utils.FusekiAuthenticationUtilities;
...
public class FusekiWriter {
    ...
    public static void run(FusekiAuthenticationUtilities.ConnectionProperties conn) throws IOException, SAXException, TransformerException {
        ...
        String xmlFilePath = "src/main/resources/formats_data/ZahtevZaPriznanjeZiga.xml";

        String rdfFilePath = "src/main/resources/formats_data/ZahtevZaPriznanjeZiga.rdf";

package com.example.XML_WS_Trademark_backend.configs;

public class Settings {
    public static final String REQ_NAME = "ZahtevZaPriznanjeZiga";
    ...
    public static final String PREDICATE_NAMESPACE = "xmlns:pred=\"http://www.ftn.uns.ac.rs/zahtev_za_zig/pred/\"";

...
public class JaxbReader {
    public static ZahtevZaAutorskaPrava ispis(String collectionName, String documentName) throws Exception {
        ...
        ZahtevZaAutorskaPrava zahtevZaAutorskaPrava =null;
        ...
        try {
            ...
            if (res == null) {
                ...
                JAXBContext context = JAXBContext.newInstance(ZahtevZaAutorskaPrava.class);

                Unmarshaller unmarshaller = context.createUnmarshaller();

                zahtevZaAutorskaPrava = (ZahtevZaAutorskaPrava) unmarshaller.unmarshal(res.getContentAsDOM());

                System.out.println("[INFO] Showing the document as JAXB instance: ");
                System.out.println(zahtevZaAutorskaPrava);

...
public class HtmlTransformer {
    ...
    public static final String HTML_FILE = "data/transform_result/html/autorska_prava.html";

    public static final String INPUT_FILE = "data/autorska_prava/ZAHTEV_ZA_AUTORSKA_PRAVA.xml";

    public static final String XSL_FILE = "data/xslt/autorska_prava.xsl";

...
public class JaxbWriter {
    ...
    public static ZahtevZaAutorskaPrava upis(String collectionName, String documentName, ZahtevZaAutorskaPrava zahtevZaAutorskaPrava) throws Exception {
        ...
        try {
            ...
            marshaller.marshal(zahtevZaAutorskaPrava, os);

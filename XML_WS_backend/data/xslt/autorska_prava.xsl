...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:b="http://www.ftn.uns.ac.rs/zahtev_za_autorska_prava" version="2.0">

    <xsl:template match="b:Zahtev_za_autorska_prava">
        <html>
            <head>
            </head>
            <body>
                <p style='margin:0cm;margin-bottom:.0001pt;font-size:13px;font-family:Verdana, Geneva, Tahoma, sans-serif;line-height:115%;border:none;'><span style='font-size:15px;line-height:115%;font-family:Arial, Helvetica, sans-serifcolor:black;'>&#160;</span></p>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 50%;border: 1pt solid black;padding: 0cm 5.4pt;height: 16.75pt;vertical-align: top;">
                                                        <p style='margin:0cm;margin-bottom:.0001pt;font-size:13px;font-family:Verdana, Geneva, Tahoma, sans-serif;'><span style='font-family:Arial, Helvetica, sans-serif'>телефон:&#160; &#160; &#160; &#160; &#160;&#160;</span></p>
                                                    </td>
                                                    <td style="width: 50%;border-top: 1pt solid black;border-right: 1pt solid black;border-bottom: 1pt solid black;border-image: initial;border-left: none;padding: 0cm 5.4pt;height: 16.75pt;vertical-align: top;">
                                                        <p style='margin:0cm;margin-bottom:.0001pt;font-size:13px;font-family:Verdana, Geneva, Tahoma, sans-serif;'><span style='font-family:Arial, Helvetica, sans-serif'>e-mail:</span></p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>

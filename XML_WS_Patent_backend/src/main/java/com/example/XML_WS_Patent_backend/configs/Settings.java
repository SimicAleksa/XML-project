package com.example.XML_WS_Patent_backend.configs;

public class Settings {
    public static final String REQ_NAME = "Zahtev_za_patent";
    ...
    public static final String PREDICATE_NAMESPACE = "xmlns:pred=\"http://www.ftn.uns.ac.rs/zahtev_za_patent/pred/\"";
}
